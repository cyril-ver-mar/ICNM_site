...
- **v1 (2026-08-31)** — Top-level menu: Об институте; Структура; **Научная деятельность**; Новости; Мероприятия; Контакты. **Обратная связь** sits under Контакты (not a seventh root and not under «Ещё»). **Об институте** dropdown: сведения, руководство, учёный совет, документы, **материальная база**, **вакансии**. **Научная деятельность** dropdown: разработки, сотрудничество, **публикации**, научно-ориентированное образование (аспирантура, докторантура, совет по защитам, стажировки, курсы). **Новости** is one page with two blocks (новости Института + СМИ о нас), not a dropdown. A parent with children is itself a link; the dropdown repeats that page first (same title, no «страница раздела» caption). Профсоюз и совет молодых учёных живут в выпадающем списке Структуры (после административных единиц, с визуальным разделителем). No separate announcements feed. Footer also has webmail, URL filled after PHP hosting exists. Search and sitemap stay header/footer utilities, not extra top-menu roots.
- **v1 (2026-08-31)** — Laboratory pages are self-contained packs under `labs/{slug}/` on this site. They are **not** separate domains in v1. Staff, directions, equipment, developments, and publications on a lab page feed the institute catalogues. A pack can later be lifted to a subdomain without rewriting the IA.
...
- **v1 (2026-08-31)** — Education block is titled **Научно-ориентированное образование** and sits under Научная деятельность. Children: аспирантура, докторантура, совет по защитам, стажировки и курсы.
